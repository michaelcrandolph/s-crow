...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s s-crow-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  s-crow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded s-crow transaction") + "\n" +
              "  s-crow-tx [options] -create [commands]   " + _("Create hex-encoded s-crow transaction") + "\n" +
              "\n";
