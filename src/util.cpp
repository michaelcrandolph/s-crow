...
const char * const BITCOIN_CONF_FILENAME = "s-crow.conf";
const char * const BITCOIN_PID_FILENAME = "s-crow.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "s-CROW";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/s-CROW";
#else
    // Unix
    return pathRet / ".s-crow";
#endif
#endif
}
