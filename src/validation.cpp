...
#if defined(NDEBUG)
# error "s-CROW cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "s-CROW Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SCW additional fees, %d delta bytes\n",
